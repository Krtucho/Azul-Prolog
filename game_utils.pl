...
:-dynamic plays/3.
%se utiliza para guardar la mejor jugada que puede hacer un jugador en su turno, en este caso seria el primer argumento el jugador, en el segundo 
%la fila en que se pondrian los azulejos previamente seleccionados como tercero la cantidad de azulejos que se descartan y 
